...
String name=(String)session.getAttribute("sname");
	...
	ResultSet rs = null;
		String sql=null;
	 sql = "select uid,name,fid,fname,fsize,b1,date,status from filestore where fid ='"+fid+"'";
  ...
  <div id="content"> 
    ...
    <p><img src="images/upload.png" width="40" height="40">&nbsp;&nbsp; <strong><h1><font color=#6666ff>File 
    ...
    <!-- Primary content: Stuff that goes in the primary content column (by default, the left column) -->
        ...
        <form name="a" action="cloud1_update1.jsp" method="post">
          <table align=center>
            ...
            <tr> 
              <td><font size="+1"><strong>File Block1</strong><td><textarea name="b1" cols="45" rows="5" class="b"><%=data1%></textarea></td>
            </tr>
            <tr> 
              <td></td>
