...
<table>
  <table border=3>
     <tr><td> <a href="cloud2_home.jsp" class="active" ><h3>Cloud server2 Home</a>
      <td><a href="cloud2_all_files.jsp" ><h3>All Files</a>
...
String name=(String)session.getAttribute("sname");
	...
	ResultSet rs = null;
		String sql=null;
	 sql = "select uid,name,fid,fname,fsize,b2,date,status from filestore where fid ='"+fid+"'";
    ...
    <!-- Primary content: Stuff that goes in the primary content column (by default, the left column) -->
        ...
        <form name="a" action="cloud2_update2.jsp" method="post">
          <table align=center>
            ...
            <tr> 
              <td><font size="+1"><strong>File Block 3</strong><td><textarea name="b1" cols="45" rows="5" class="b"><%=data1%></textarea></td>
            </tr>
            <tr> 
              <td></td>
